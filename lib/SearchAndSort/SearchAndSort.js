...
class SearchAndSort extends React.Component {
  ...
  render() {
    ...
    const displayedRecords = parentResources.records;
    const paneSub = (_.isEmpty(filters) && _.isEmpty(displayedRecords) && searchTerm === '') ? formatMsg({ id: 'stripes-smart-components.searchCriteria' }) : formatMsg({ id: `ui-${moduleName}.resultCount` }, { count });
